...
function calcGPA() {
  const grades = document.querySelectorAll('.gradeInputNew');
  const hours = document.querySelectorAll('.hoursInput');
...
function resetGPA() {
  document.querySelectorAll('.gradeInputNew, .hoursInput').forEach(e => (e.value = ''));
